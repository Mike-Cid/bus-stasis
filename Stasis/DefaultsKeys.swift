...
extension Defaults.Keys {
    ...
    static let showWorkWithAC = Key<Bool>("showWorkWithAC", default: true)
    static let showChargeLimitOverride = Key<Bool>("showChargeLimitOverride", default: true)
    static let showForceDischarge = Key<Bool>("showForceDischarge", default: true)
    ...
    // Set states
    static let workWithACActive = Key<Bool>("workWithACActive", default: false)
}
