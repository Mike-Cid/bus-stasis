...
struct DashboardSettingsView: View {
    ...
    @Default(.showWorkWithAC) var showWorkWithAC
    @Default(.showChargeLimitOverride) var showChargeLimitOverride
    @Default(.showForceDischarge) var showForceDischarge
    ...
    var body: some View {
        Form {
            ...
            Section("Charging Controls") {
                Toggle("Work with AC", isOn: $showWorkWithAC)
                Toggle("Charge Limit Override", isOn: $showChargeLimitOverride)
                Toggle("Force Discharge", isOn: $showForceDischarge)
            }
        }
        .formStyle(.grouped)
